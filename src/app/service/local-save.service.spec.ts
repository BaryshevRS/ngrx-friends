...
describe('LocalSaveService', () => {
    ...
    describe('Localstorage empty', () => {
        beforeEach(() => {
            ...
            spyOn(localStorage, 'getItem').and.callFake(function (key: string): string {
                return store[key] || '';
            });
        ...
        it('should be set', inject([LocalSaveService], (service: LocalSaveService) => {
            ...
            expect(localStorage.setItem).toHaveBeenCalledWith(moskName, JSON.stringify(moskValue));
        }));

        it('should be get', inject([LocalSaveService], (service: LocalSaveService) => {
            const moskName = 'friendsBookmark';
    ...
    describe('Localstorage full', () => {
        ...
        it('should be set', inject([LocalSaveService], (service: LocalSaveService) => {
            ...
            expect(localStorage.setItem).toHaveBeenCalledWith(moskName, JSON.stringify(moskValueReturn));
        }));
