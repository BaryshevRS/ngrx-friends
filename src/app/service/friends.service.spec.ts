...
describe('FriendsService', () => {
    ...
    moskConfigsFriends = {typeSort: 0, searchValue: '', showBookmark: false, startView: 0, limitView: 10};
    ...
    it('should be filter bookmark', inject([FriendsService], (service: FriendsService) => {

        const serviceMoskFriends = [new Friend('1', 'first_name', 'last_name')];
        serviceMoskFriends[0].bookmark = 1;

        expect({...service.getFilterBookmark(serviceMoskFriends)}).toEqual({...serviceMoskFriends});
