...
import {ErrorsFriends, GetFriend, GetFriends, LoadFriends, SetFriendDescription} from '../action';
...
describe('LoadFriendsEffect', () => {
    ...
    describe('Catch Error load friends', () => {
        ...
        it('should be error empty load friends', () => {
            const action = new GetFriends();
            const completion = new ErrorsFriends(new ErrorMessage('danger', 'errorMessage.friendsEmpty'));
    ...
    describe('Empty friends list', () => {
        ...
        it('should be load empty friends list', () => {
            ...
            moskStore = {
                ...moskStore,
                friends: {...moskStore.friends, errors: new ErrorMessage('info', 'errorMessage.friendsEmpty')}
            };
    ...
    describe('Empty search list', () => {
        ...
        let moskStore = {
            friends: {
                friends: [],
                configsFriends: {typeSort: 0, searchValue: 'test', showBookmark: false, startView: 0, limitView: 0},
                errors: null
            }
        };
        ...
        it('should be not load result for search', () => {
            ...
            moskStore = {
                ...moskStore,
                friends: {...moskStore.friends, errors: new ErrorMessage('info', 'errorMessage.searchEmpty')}
            };
    ...
    describe('Empty bookmark list', () => {
        ...
        it('should be not load bookmark list', () => {
            ...
            moskStore = {
                ...moskStore,
                friends: {...moskStore.friends, errors: new ErrorMessage('info', 'errorMessage.bookmarkEmpty')}
            };
